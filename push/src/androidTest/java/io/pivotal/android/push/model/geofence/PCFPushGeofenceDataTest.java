...
public class PCFPushGeofenceDataTest extends AndroidTestCase {
    ...
    public void testNewCopyWithoutLocations() throws IOException {
        ...
        final PCFPushGeofenceData item = ModelUtil.getJson(getContext(), "geofence_one_item_persisted_1.json", typeToken);
        ...
        assertEquals(1, copy.getPayload().getAndroid().size());
        assertEquals("tacos", copy.getPayload().getAndroid().get("message"));
