...
public class PCFPushGetGeofenceUpdatesApiRequestTest extends AndroidTestCase {
    ...
    public void testSuccessfulGeofenceUpdateRequest() throws IOException {
        makeListenersForSuccessfulRequestFromNetwork(true, 200, "geofence_response_data_one_item.json", 99, TEST_DEVICE_UUID, null);
    ...
    public void testSuccessfulGeofenceUpdateRequestWithCustomRequestHeaders() throws IOException {
        ...
        makeListenersForSuccessfulRequestFromNetwork(true, 200, "geofence_response_data_one_item.json", 99, TEST_DEVICE_UUID, expectedRequestHeaders);
        final PCFPushGetGeofenceUpdatesApiRequest request = new PCFPushGetGeofenceUpdatesApiRequest(getContext(), networkWrapper);
    ...
    public void testNewDeviceRegistrationSuccessful404() throws IOException {
        makeListenersForSuccessfulRequestFromNetwork(false, 404, "geofence_response_data_one_item.json", 0, TEST_DEVICE_UUID, null);
        final PCFPushGetGeofenceUpdatesApiRequest request = new PCFPushGetGeofenceUpdatesApiRequest(getContext(), networkWrapper);
        request.getGeofenceUpdates(0, TEST_DEVICE_UUID, getParameters(), listener);
        delayedLoop.startLoop();
        assertTrue(delayedLoop.isSuccess());
    ...
    private PushParameters getParameters() {
        return new PushParameters(null, TEST_PLATFORM_UUID, TEST_PLATFORM_SECRET, TEST_SERVICE_URL, null, null, null, true, Pivotal.SslCertValidationMode.DEFAULT, null, null);
    }

    private PushParameters getParameters(Map<String, String> requestHeaders) {
        return new PushParameters(null, TEST_PLATFORM_UUID, TEST_PLATFORM_SECRET, TEST_SERVICE_URL, null, null, null, true, Pivotal.SslCertValidationMode.DEFAULT, null, requestHeaders);
    }
}
