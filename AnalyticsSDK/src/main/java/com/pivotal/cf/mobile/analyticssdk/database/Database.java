...
public class Database extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_FILENAME = "com.pivotal.cf.mobile.analyticssdk.events.db";
    public static final String AUTHORITY = "com.pivotal.cf.mobile.analyticssdk.providers.EventsDatabase";
