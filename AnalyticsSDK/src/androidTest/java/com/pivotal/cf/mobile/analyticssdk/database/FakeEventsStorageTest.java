...
public class FakeEventsStorageTest extends AndroidTestCase {
	...
	protected void setUp() throws Exception {
		super.setUp();
		EVENT_1 = DummyEvent.getEvent(TEST_VARIANT_ID_1, TEST_MESSAGE_UUID_1, TEST_DEVICE_ID_1);
		EVENT_2 = DummyEvent.getEvent(TEST_VARIANT_ID_2, TEST_MESSAGE_UUID_2, TEST_DEVICE_ID_2);
		EVENT_3 = DummyEvent.getEvent(TEST_VARIANT_ID_3, TEST_MESSAGE_UUID_3, TEST_DEVICE_ID_3);
