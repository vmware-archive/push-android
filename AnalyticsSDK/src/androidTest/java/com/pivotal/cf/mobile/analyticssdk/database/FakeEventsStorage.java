...
public class FakeEventsStorage implements EventsStorage {
    ...
    /**
     * Saves a {@link com.pivotal.cf.mobile.analyticssdk.model.events.Event} object into the fake filesystem.
     *
     * @param event
     */
    @Override
    ...
    /**
     * Gets the filenames for all the {@link com.pivotal.cf.mobile.analyticssdk.model.events.Event} objects currently in the fake filesystem.
     */
    @Override
    ...
    /**
     * Gets the {@link com.pivotal.cf.mobile.analyticssdk.model.events.Event} objects currently in the fake filesystem that match the given status
     *
     * @param status
     */
    @Override
    ...
    /**
     * Retrieves the {@link com.pivotal.cf.mobile.analyticssdk.model.events.Event} object with the given filename from the fake filesystem.
     */
    @Override
    ...
    /**
     * Deletes the {@link com.pivotal.cf.mobile.analyticssdk.model.events.Event} objects from the fake filesystem with the given list of filenames.
     */
    @Override
    ...
    /**
     * Returns the number of {@link com.pivotal.cf.mobile.analyticssdk.model.events.Event} objects currently in the fake filesystem.
     */
    ...
    /**
     * Clears all {@link com.pivotal.cf.mobile.analyticssdk.model.events.Event} objects from the fake filesystem.
     */
    @Override
    public void reset() {
        events.clear();
