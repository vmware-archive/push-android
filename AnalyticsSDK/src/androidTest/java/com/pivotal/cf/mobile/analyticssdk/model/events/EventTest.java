...
import com.pivotal.cf.mobile.analyticssdk.database.FakeCursor;
...
public class EventTest extends AndroidTestCase {
    ...
    public void testConvertStringToList() {
        ...
        assertEquals(TEST_MESSAGE_UUID_1, list.get(0).getData().get(DummyEvent.MESSAGE_UUID));
        assertEquals(TEST_MESSAGE_UUID_2, list.get(1).getData().get(DummyEvent.MESSAGE_UUID));
    }
    ...
    public void testConvertListToString() {
        ...
        assertTrue(str.contains("\"type\":\"" + DummyEvent.EVENT_TYPE + "\""));
    ...
    public void testGetCreateTableSqlStatement() {
        ...
        assertNotNull(sql);
        Logger.i("Create table statement: " + sql);
    ...
    public void testGetDropTableSqlStatement() {
        ...
        assertNotNull(sql);
        Logger.i("Drop table statement: " + sql);
    ...
    private static HashMap<String, Object> getEventData1() {
        ...
        map.put(DummyEvent.MESSAGE_UUID, TEST_MESSAGE_UUID_1);
        return map;
    }

    private static HashMap<String, Object> getEventData2() {
        final HashMap<String, Object> map = new HashMap<String, Object>();
        map.put(DummyEvent.MESSAGE_UUID, TEST_MESSAGE_UUID_2);
