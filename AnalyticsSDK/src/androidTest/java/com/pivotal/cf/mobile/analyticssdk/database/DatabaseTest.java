...
public class DatabaseTest extends AndroidTestCase {
    ...
    public void testDatabaseSettings() {
        Assert.assertEquals(Database.DATABASE_VERSION, database.getVersion());
    }
    ...
    public void testInsertOneRow() {
        final Event event = DummyEvent.getEvent(TEST_VARIANT_UUID_1, TEST_MESSAGE_UUID_1, TEST_DEVICE_ID_1);
    ...
    public void testInsertTwoRows() {
        final Event event1 = DummyEvent.getEvent(TEST_VARIANT_UUID_1, TEST_MESSAGE_UUID_1, TEST_DEVICE_ID_1);
        long rowId1 = database.insert(TABLE_NAME, null, event1.getContentValues());
        assertFalse(-1 == rowId1);
        final Event event2 = DummyEvent.getEvent(TEST_VARIANT_UUID_2, TEST_MESSAGE_UUID_2, TEST_DEVICE_ID_2);
